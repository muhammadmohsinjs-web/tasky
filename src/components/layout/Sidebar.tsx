        ...
        <div className="px-5 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-slate-900 flex items-center justify-center shadow-md">
              <CheckSquare className="w-4 h-4 text-white" strokeWidth={2.4} />
            </div>
            <div className="flex flex-col">
              <span className="text-lg font-semibold tracking-tight text-slate-900 leading-tight">Tasky</span>
              <span className="text-[10px] font-semibold text-slate-400 tracking-[0.16em] uppercase">Workspace</span>
            </div>
          </div>
          <button
            onClick={() => setMobileOpen(false)}
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `group flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-medium transition-all duration-200 relative border ${
                  isActive
                    ? 'bg-blue-50/70 border-blue-100 text-slate-800 shadow-sm'
              ...
              {({ isActive }) => (
                <>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span
                      className={`block text-[10px] font-normal leading-tight mt-0.5 transition-colors ${
