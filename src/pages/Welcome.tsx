      ...
      <div className="max-w-md w-full">
        ...
        >
          <button
            ...
            disabled={signingIn}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-slate-200 rounded-xl shadow-sm text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 cursor-pointer transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
